...
function login($db, $text_frontend, $username_form, $user_password_form) {

$errors = array();

if (is_login_blocked($db, $username_form)) {
$errors [] = $text_frontend['message_login_too_many_attempts'];
return $errors;
}

if (empty($username_form)) {
$errors [] = $text_frontend['message_login_no_username'];
}

if (empty($user_password_form)) {
$errors [] = $text_frontend['message_login_no_password'];
}
...
$errors [] = $text_frontend['message_login_failed'];
