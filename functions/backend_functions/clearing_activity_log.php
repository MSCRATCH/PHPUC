...
function clearing_activity_log($db, $text_backend, $total_number_entries_activity_log, $result) {
...
$errors [] = $text_backend['message_activity_log_save_failed'];
return $errors;
} else {
$remove_entries_activity_log = remove_entries_activity_log($db);
if ($remove_entries_activity_log === false) {
$errors [] = $text_backend['message_activity_log_remove_failed'];
return $errors;
}
}
}
