...
function save_blog_post($db, $text_backend, $blog_post_title_form, $blog_post_content_form, $user_id_blog_post) {

$errors = array();

if (empty($blog_post_title_form)) {
$errors [] = $text_backend['message_manage_blog_no_title'];
}

if (empty($blog_post_content_form)) {
$errors [] = $text_backend['message_manage_blog_no_content'];
}
...
function update_blog_post($db, $text_backend, $blog_post_title_update_form, $blog_post_content_update_form, $blog_post_id_get, $user_id_blog_post) {
