...
function backend_login($db, $text_backend, $backend_login_name_form, $backend_login_password_form) {

$errors = array();

if (is_login_blocked($db, $backend_login_name_form)) {
$errors [] = $text_backend['message_backend_login_too_many_attempts'];
return $errors;
}

if (empty($backend_login_name_form)) {
$errors [] = $text_backend['message_backend_login_no_username'];
}

if (empty($backend_login_password_form)) {
$errors [] = $text_backend['message_backend_login_no_password'];
}
...
$errors [] = $text_backend['message_backend_login_failed'];
