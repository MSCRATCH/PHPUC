...
<div class="column">
<form method="post">
<label class="label_default" for="backend_login_name_form"><?php echo sanitize_1($text_backend['backend_login_template_label_username']);?></label>
<input class="form_text_default" type="text" name="backend_login_name_form" id="backend_login_name_form" placeholder="Username">
<label class="label_default" for="backend_login_password_form"><?php echo sanitize_1($text_backend['backend_login_template_label_password']);?></label>
...
<button class="btn_dynamic_mtb" type="submit" name="backend_login"><?php echo sanitize_1($text_backend['backend_login_template_btn']);?></button>
</form>
<a href="index.php"><button class="btn_dynamic_mtb"><?php echo sanitize_1($text_backend['backend_login_template_btn_return']);?></button></a>
</div>
</div>
</div>
